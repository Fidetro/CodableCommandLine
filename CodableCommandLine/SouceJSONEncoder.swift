...
private class __JSONDecoder : Decoder {
    ...
    let options: SourceJSONDecoder._Options
    ...
    init(referencing container: Any, at codingPath: [CodingKey] = [], options: SourceJSONDecoder._Options) {
...
private struct _JSONKeyedDecodingContainer<K : CodingKey> : KeyedDecodingContainerProtocol {
    ...
    init(referencing decoder: __JSONDecoder, wrapping container: [String : Any]) {
        ...
        case .convertFromSnakeCase:
            ...
            self.container = Dictionary(container.map {
                key, value in (SourceJSONDecoder.KeyDecodingStrategy._convertFromSnakeCase(key), value)
    ...
    private func _errorDescription(of key: CodingKey) -> String {
        ...
        case .convertFromSnakeCase:
            ...
            let roundtrip = SourceJSONDecoder.KeyDecodingStrategy._convertFromSnakeCase(converted)
